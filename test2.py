...
# -------------------------------
st.set_page_config(
    page_title="💼 Pro Salary Prediction Dashboard",
    layout="wide",
    page_icon="💼"
)

st.title("💼 Pro Salary Prediction Dashboard (Dynamic Model)")
...
fig.update_layout(yaxis_title="Salary (USD)", xaxis_title="Year", hovermode="x unified")
