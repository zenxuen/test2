...
uploaded_file = st.file_uploader("salaries_cyber_clean.csv", type=["csv"])
...
if uploaded_file:
    ...
    st.info("Please upload a CSV file to start predicting salaries.")
