...
# ---------------------------------------------------------
# Load CSV Dataset (fixed path)
# ---------------------------------------------------------
file_path = "./salaries_cyber_clean.csv"  # adjust path if needed
...
fig.update_traces(line=dict(width=4), marker=dict(size=10))  # make line and markers more visible
fig.update_layout(yaxis_title="Salary (USD)", xaxis=dict(dtick=1))  # visible gaps between years
