...
st.title("💼 Salary Prediction Dashboard (Memorised Model)")
...
# Memorise dataset: train model once
...
# Forecast 2021–2035 based on memorised dataset
...
# Plot
st.subheader("📈 Salary Forecast (Memorised Dataset)")
fig = px.line(
    forecast_df,
    x="Year",
...
fig.update_layout(yaxis_title="Salary (USD)", xaxis=dict(dtick=1), hovermode="x unified")
